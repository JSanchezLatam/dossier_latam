...
const LatamDigitalDossier = () => {
      ...
      <div className="prose prose-lg max-w-none">
        ...
        <div className="bg-latam-orange-50 p-6 rounded-lg my-8 border-l-4 border-latam-orange">
          ...
          <p className="text-lg leading-relaxed text-latam-gray-700">
            ...
            servicio, valor del negocio, optimización de sus recursos y
          ...
          <div className="space-y-4">
            <div className="flex items-start gap-3">
              ...
              <p className="text-lg text-latam-gray-700">
                ...
                bioinformática y tecnologías emergentes.
              </p>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <p className="text-lg text-latam-gray-700">
                <strong>Cultura de servicio excepcional</strong> que nos
                convierte en socios tecnológicos de largo plazo, no en
      ...
      <div className="bg-gradient-to-br from-latam-blue-50 to-latam-blue-100 p-8 rounded-lg mb-8">
        ...
        <div className="prose prose-lg max-w-none space-y-6">
          <p className="text-lg leading-relaxed text-latam-gray-700">
            ...
            clara: ofrecer servicios que generaran valor real a nuestros
            clientes, diferenciándonos de lo que veíamos en el mercado.
          </p>
          ...
          <div className="bg-white p-6 rounded-lg my-6 border-l-4 border-latam-blue-600">
            ...
            <p className="text-lg leading-relaxed text-latam-gray-700">
              ...
              inflexión. Nos demostró que cuando combinamos conocimiento
              profundo, experiencia práctica y compromiso genuino, podemos
              resolver desafíos complejos en organizaciones de alto nivel.
            </p>
          </div>
          ...
          <p className="text-lg leading-relaxed text-latam-gray-700">
            ...
            anticipamos. Por eso hemos evolucionado constantemente: de
            consultoría tradicional a servicios digitales, de ecosistemas
            digitales a soluciones de IA, y ahora, pioneros en soluciones
            médicas digitales y bioinformática.
          </p>

          <p className="text-lg leading-relaxed text-latam-gray-700">
            Este 2026 marca otro momento decisivo con el desarrollo de{" "}
            <strong>Microbiome Radar</strong>, un proyecto que representa
            nuestra apuesta por la innovación que rompe esquemas. Es muy posible
            que nos especialicemos cada vez más en sectores que demanden alta
            innovación y que estén listos para transformarse.
          </p>
          ...
          <div className="bg-gradient-to-r from-latam-blue-900 to-latam-blue-800 text-white p-6 rounded-lg my-6">
            ...
            <p className="text-lg leading-relaxed">
              En 19 años han intentado llevarnos al camino de la corrupción, y
              lo hemos rechazado. Nuestros valores éticos y morales son
              innegociables. Somos honestos con nuestros clientes, transparentes
              en nuestras relaciones y comprometidos con la excelencia.
            </p>
          </div>

          <p className="text-lg leading-relaxed text-latam-gray-700">
            Lo que nos emociona del futuro de la tecnología aplicada es todo.
            Cada reconocimiento que hemos ganado —desde Microsoft Startup
            Founder Hub hasta el Premio Nacional de Innovación 2024, pasando por
            la distinción de la Universidad Técnica de Berlín— valida que
            estamos en el camino correcto.
          </p>

          <p className="text-lg leading-relaxed text-latam-gray-700">
            Pero más que los premios, lo que realmente nos impulsa es ver cómo
            el 95% de nuestro talento en outsourcing es internalizado por
            nuestros clientes en promedio de 18 meses. No es una condición
            contractual. Es la consecuencia directa de un servicio sólido,
            cercano y alineado con los objetivos del negocio.
          </p>

          <div className="mt-8 pt-6 border-t-2 border-latam-blue-200">
            <p className="text-xl font-bold text-latam-blue-900 italic">
              &quot;En Latam Digital no vendemos tecnología. Construimos
              relaciones de confianza, ejecutamos con sensatez y hacemos que la
              tecnología genere valor real para el negocio.&quot;
            </p>
  ...
  const Historia = () => (
    <div className="p-8 max-w-5xl mx-auto">
      ...
      <div className="relative">
        <div className="absolute left-8 top-0 bottom-0 w-1 bg-latam-blue-200"></div>
          ...
          {[
            {
              year: "2007",
              title: "Fundación",
              desc: "Inicio como empresa de consultoría especializada en gobernanza, riesgos, ciberseguridad, auditoría de sistemas y protección de datos.",
            },
            {
              year: "2013",
              title: "Expansión de Servicios",
              desc: "Incorporación de servicios de outsourcing estratégico.",
            },
            {
              year: "2016",
              title: "Ampliación de Equipo",
              desc: "Ampliación de equipo de consultoría.",
            },
            {
              year: "2017",
              title: "Gestión Digital 360",
              desc: "Lanzamiento del modelo de gestión digital integral.",
            },
            {
              year: "2020",
              title: "Soluciones Digitales",
              desc: "Consolidación como desarrolladores de soluciones digitales a medida.",
            },
            {
              year: "2021",
              title: "Innovación Digital",
              desc: "Enfoque estratégico en innovación digital aplicada.",
            },
            {
              year: "2022",
              title: "Inteligencia Artificial",
              desc: "Inicio de desarrollo de soluciones basadas en IA.",
            },
            {
              year: "2023",
              title: "Soluciones Médicas Digitales",
              desc: "Entrega de soluciones médicas innovadoras y entrada al sector salud.",
            },
            {
              year: "2024",
              title: "Bioinformática",
              desc: "Desarrollo de soluciones especializadas en bioinformática. Premio Nacional de Innovación - Tercer Lugar.",
            },
            {
              year: "2026",
              title: "IA Sectorial",
              desc: "Especialización en ecosistemas de IA para sectores financiero y salud. Desarrollo de Microbiome Radar.",
            },
          ].map((item, idx) => (
      ...
      <div className="mt-12 p-6 bg-gradient-to-r from-latam-blue-600 to-latam-blue-700 text-white rounded-lg">
        <p className="text-xl font-semibold text-center">
          De consultoría tradicional a pioneros en innovación digital, IA y
          bioinformática
        </p>
      </div>
    </div>
      ...
      <div className="space-y-12">
        <div className="bg-gradient-to-br from-latam-blue-50 to-latam-blue-100 p-8 rounded-lg shadow-lg">
          ...
          <p className="text-lg mb-6 leading-relaxed text-latam-gray-700">
            ...
            negocio, incorporando transformación digital, innovación e
            inteligencia artificial de forma estructurada, sensata y escalable.
          </p>
        ...
        <div className="bg-gradient-to-br from-latam-blue-50 to-latam-blue-100 p-8 rounded-lg shadow-lg">
          ...
          <p className="text-lg mb-6 leading-relaxed text-latam-gray-700">
            Operamos tu ecosistema digital con estabilidad, seguridad y visión
            de negocio, actuando como un socio tecnológico de confianza que
          ...
          <div className="bg-white p-6 rounded-lg mb-6">
            ...
            <p className="text-lg text-latam-gray-700">
              ...
              continuidad del negocio y nos involucramos más allá de lo
              requerido.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="bg-white p-4 rounded-lg">
              <p className="font-semibold text-latam-blue-700">
          ...
          <div className="space-y-4">
            <div className="bg-white p-4 rounded-lg">
              ...
              <p className="text-latam-gray-700">
                Para necesidades específicas del negocio
              </p>
            </div>
            ...
            <div className="bg-white p-4 rounded-lg">
              ...
              <p className="text-latam-gray-700">De forma práctica y segura</p>
            </div>
            ...
            <div className="bg-white p-4 rounded-lg">
              ...
              <p className="text-latam-gray-700">Para eficiencia operativa</p>
            </div>

            <div className="bg-white p-4 rounded-lg">
              <h4 className="font-bold text-latam-blue-700 mb-2">
                Talento especializado en outsourcing
              </h4>
              <p className="text-latam-gray-700">
                Integrado directamente al negocio
              </p>
            </div>
          </div>
        </div>
      ...
      <div>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {[
            ...
            {
              cert: "CDPSE",
              desc: "Certified Data Privacy Solutions Engineer",
            },
            {
              cert: "COBIT Assessor",
              desc: "Evaluación de Gobierno y Gestión de TI",
            },
            { cert: "SMC Certification", desc: "Scrum Master Certified" },
            { cert: "Scrum Foundation", desc: "Fundamentos de Scrum" },
            {
              cert: "Professional Scrum Master",
              desc: "Scrum Master Profesional",
            },
            ...
            {
              cert: "Design & Visual Thinking",
              desc: "Pensamiento de Diseño y Visual",
            },
          ].map((item, idx) => (
            <div
              key={idx}
      ...
      <div className="mb-12">
        ...
        <div className="grid md:grid-cols-4 gap-3">
          {[
            ...
            <div
              key={idx}
              className="bg-latam-blue-100 p-3 rounded-lg text-center"
            >
      ...
      <div>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="bg-gradient-to-br from-latam-orange-50 to-latam-orange-100 p-6 rounded-lg border-l-4 border-latam-orange-600">
            ...
            <p className="text-latam-gray-700">
              Iniciando presencia en los últimos tres años con soluciones
              médicas digitales, bioinformática e IA aplicada a la salud.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-6">
        ...
        <div className="bg-gradient-to-r from-latam-blue-700 to-latam-blue-900 text-white p-8 rounded-lg shadow-xl">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <h3 className="text-2xl font-bold">
                ISV Success Program de Microsoft
              </h3>
              <p className="text-latam-blue-100">Certificación de Excelencia</p>
            </div>
          </div>
          <p className="text-lg">
            Programa de Microsoft que certifica nuestra excelencia en el
            desarrollo de software con altos estándares de calidad y desempeño.
          </p>
        </div>
        ...
        <div className="bg-gradient-to-r from-latam-blue-800 to-latam-blue-900 text-white p-8 rounded-lg shadow-xl">
          ...
          <p className="text-lg">
            ...
            innovación, con procesos sólidos y una cultura empresarial orientada
            a la excelencia.
          </p>
        </div>
      </div>
  ...
  const Diferenciadores = () => (
    <div className="p-8 max-w-6xl mx-auto">
      ...
      <div className="grid md:grid-cols-2 gap-8 mb-12">
        <div className="bg-gradient-to-br from-latam-blue-50 to-latam-blue-100 p-6 rounded-lg shadow-lg">
          <h3 className="text-xl font-bold mb-4 text-latam-blue-900">
            Trayectoria Demostrada
          </h3>
          <p className="text-latam-gray-700 leading-relaxed">
            19 años de experiencia en proyectos reales de transformación digital
            e inteligencia artificial en sectores críticos y regulados.
          </p>
        </div>

        <div className="bg-gradient-to-br from-latam-blue-50 to-latam-blue-100 p-6 rounded-lg shadow-lg">
          <h3 className="text-xl font-bold mb-4 text-latam-blue-800">
            Formación de Vanguardia
          </h3>
          <p className="text-latam-gray-700 leading-relaxed">
            Maestrías especializadas en IA aplicada a la salud y bioinformática,
            combinando academia y ejecución práctica.
          </p>
        </div>

        <div className="bg-gradient-to-br from-latam-blue-50 to-latam-blue-100 p-6 rounded-lg shadow-lg">
          <h3 className="text-xl font-bold mb-4 text-latam-blue-700">
            Cultura de Servicio Excepcional
          </h3>
          <p className="text-latam-gray-700 leading-relaxed">
            Heredada de entornos corporativos, que se traduce en cercanía,
            disponibilidad y compromiso genuino con cada cliente.
          </p>
        </div>

        <div className="bg-gradient-to-br from-latam-orange-50 to-latam-orange-100 p-6 rounded-lg shadow-lg">
          <h3 className="text-xl font-bold mb-4 text-latam-orange-900">
            Innovación Aplicada
          </h3>
          <p className="text-latam-gray-700 leading-relaxed">
            Proyectos pioneros como Microbiome Radar demuestran nuestra
            capacidad de crear soluciones que no existen en el mercado.
          </p>
        </div>

        <div className="bg-gradient-to-br from-latam-orange-50 to-latam-orange-100 p-6 rounded-lg shadow-lg">
          <h3 className="text-xl font-bold mb-4 text-latam-orange-800">
            Relaciones de Largo Plazo
          </h3>
          <p className="text-latam-gray-700 leading-relaxed">
            El 95% de nuestro talento en outsourcing es internalizado por
            nuestros clientes, evidenciando calidad y ajuste cultural.
          </p>
        </div>

        <div className="bg-gradient-to-br from-latam-orange-50 to-latam-orange-100 p-6 rounded-lg shadow-lg">
          <h3 className="text-xl font-bold mb-4 text-latam-orange-700">
            Valores Innegociables
          </h3>
          <p className="text-latam-gray-700 leading-relaxed">
            19 años manteniendo principios éticos y morales, con transparencia y
            honestidad como pilares fundamentales.
          </p>
        </div>
      </div>
      ...
      <div className="bg-gradient-to-br from-latam-blue-900 via-latam-blue-800 to-latam-blue-900 text-white p-12 rounded-lg shadow-2xl">
        ...
        <p className="text-lg leading-relaxed text-latam-blue-100">
          Actuamos como socios, no como proveedores. Nos involucramos en el
          éxito de nuestros clientes, aportamos criterio técnico con visión de
          negocio, y construimos soluciones que trascienden el proyecto para
      ...
      <div className="mt-12 text-center">
        ...
        <div className="mt-8 text-latam-gray-600 italic">
          <p>
            Construyendo el futuro digital de las organizaciones, un proyecto a
            la vez.
          </p>
        </div>
      </div>
  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center gap-2">
              <div className="w-3 h-3 bg-latam-blue rounded-full"></div>
              <div className="w-3 h-3 bg-latam-orange rounded-full"></div>
              <div className="w-3 h-3 bg-latam-blue-700 rounded-full"></div>
            </div>
      ...
      <main ref={contentRef}>{renderContent()}</main>
    </div>
  );
};
